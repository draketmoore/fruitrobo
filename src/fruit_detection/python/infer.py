...
def visualize(image_file, results, labels, output_dir='output/', threshold=0.5):
    ...
    img_name = FLAGS.timestamp + '.jpg'

    im = visualize_box_mask(image_file, results, labels, threshold=threshold, imname=img_name)
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        ...
        type=str,
        default='',
        help="Timestamp of the image or video file."
    )
